...
def sample_image_inference(
    ...
    width = prompt_dict.get("width", 1024) if args.frame==4 else prompt_dict.get("width", 1056)
    height = prompt_dict.get("height", 1024) if args.frame==4 else prompt_dict.get("height", 1056)
